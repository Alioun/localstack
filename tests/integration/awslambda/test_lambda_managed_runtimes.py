...
from localstack.services.awslambda.lambda_utils import LambdaRuntime
...
from tests.integration.awslambda.test_lambda import read_streams, is_old_provider, TEST_LAMBDA_INTEGRATION_NODEJS, \
